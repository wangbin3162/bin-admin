      ...
      <v-table-wrap>
        ...
        <v-filter-bar>
          <v-filter-item title="字典项名称">
            <b-input v-model.trim="listQuery.itemName" size="small" placeholder="请输入" clearable></b-input>
          </v-filter-item>
          <v-filter-item title="字典项编码">
            <b-input v-model.trim="listQuery.itemCode" size="small" placeholder="请输入" clearable></b-input>
          </v-filter-item>
          <!--添加查询按钮位置-->
