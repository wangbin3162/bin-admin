            ...
            <template v-slot:header>
              <div flex="main:justify cross:center" class="header-height">
                ...
                <div flex="cross:center">
                  ...
                  <b-button type="text" :disabled="centerStatisLoading"
                            @click="handleMoreBtn('bmsjgjfx', '部门数据归集统计分析')">更多>>
                  </b-button>
                </div>
              </div>
            </template>
              ...
              <b-card head-tip divider="no" :bordered="false" radius="10px"
                ...
                <template v-slot:header>
                  <div flex="main:justify cross:center" class="header-height">
                    ...
                    <div>
                      <b-button type="text" :disabled="centerStatisLoading" @click="handleMoreBtn('zxtbbm', '最新提报部门')">
                        更多>>
                      </b-button>
                    </div>
                  </div>
            ...
            <template v-slot:header>
              <div flex="main:justify cross:center" class="header-height">
                ...
                <div>
                  ...
                  <b-button type="text" :disabled="xxgjNewLoading" @click="handleMoreBtn('xxgjjl', '信息归集记录')">更多>>
                  </b-button>
                </div>
              </div>
            </template>
            <div class="pl-20 pr-20">
              <b-table :columns="xxgjjlColumns" :data="xxgjjlData.slice(1, 7)" size="small" class="mb-10"
                       :loading="xxgjNewLoading">
              </b-table>
            </div>
          </b-card>
        </div>
