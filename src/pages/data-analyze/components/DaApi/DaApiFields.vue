    ...
    <b-modal v-model="dialogFormVisible" width="800"
      ...
      <div class="p10">
        <b-form :model="metaItem" ref="form" :rules="ruleValidate" :label-width="80">
          <b-row>
            <b-col span="12">
              <b-form-item label="参数字段名" prop="fieldName">
                <b-input v-model="metaItem.fieldName" placeholder="请输入参数字段名" clearable :maxlength="30"></b-input>
              </b-form-item>
            </b-col>
            <b-col span="12">
              <b-form-item label="参数名称" prop="name">
                <b-input v-model="metaItem.name" placeholder="请输入参数名称" clearable :maxlength="30"></b-input>
              </b-form-item>
            </b-col>
          </b-row>
          <b-row>
            <b-col span="12">
              <b-form-item label="参数默认值" prop="defaultValue">
                <b-input v-model="metaItem.defaultValue" placeholder="请输入参数默认值" clearable :maxlength="30"></b-input>
              </b-form-item>
            </b-col>
            <b-col span="12">
          ...
          <b-form-item label="备注" prop="describe">
            <b-input v-model="metaItem.describe" placeholder="请输入备注" type="textarea"></b-input>
          </b-form-item>
        </b-form>
      </div>
      <div slot="footer">
  ...
  export default {
    ...
    data() {
      ...
      return {
        fieldsColumns: [
          { title: '参数名称', key: 'name' },
          { title: '参数字段名', key: 'fieldName', tooltip: true },
