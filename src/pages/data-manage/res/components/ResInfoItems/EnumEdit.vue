    ...
    <div>
      <b-table :columns="columns" :data="totalData" size="small" disabled-hover>
        ...
        <template v-slot:code="scope">
          <b-input v-model="totalData[scope.index].code" placeholder="编码" size="mini" clearable></b-input>
        </template>
        <!--名称-->
        <template v-slot:name="scope">
          <b-input v-model="totalData[scope.index].name" placeholder="名称" size="mini" clearable></b-input>
        </template>
